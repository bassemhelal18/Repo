...
class cHosterGui:
    ...
    def checkHoster(self, sHosterUrl, debrid=True):
        ...
        val = next((x for x in ['upbaam', 'upbam', 'uppom', 'uppboom', 'upgobom', 'uupbom', 'upptobom',
                                ...
                                'online20.shop', 'line50.shop', 'fo0.shop', 'online20stream','4view.shop'] if x in sHostName), None)
        if val:
        ...
        val = next((x for x in ['goved', 'govad', 'govid.me', 'goveed', 'gov1ad', 'go2ved', 'go1ved', 
                                ...
                                'go1evd', 'goverd', 'gnvd', 'go1vend', 'go1vd', 'go2vd', 'go4vd', 'gov7d'] if x in sHostName), None)
        if val:
