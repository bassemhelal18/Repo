...
class cHosterGui:
    ...
    def checkHoster(self, sHosterUrl, debrid=True):
        ...
        val = next((x for x in ['vadshar', 'vidshar', 'vedshaar', 'viidshar', 'vedshaar', 'vedsharr', 'vedshar', 'vidshare',
                                ...
                                'vd13r', 'vd1sr', 'v1dsr', 'vd2sr', 'v1d2sr', 'v2d3sr', 'vadsr'] if x in sHostName), None)
        if val:
        ...
        val = next((x for x in ['vidbm' ,'vadbam', 'vedbom', 'vadbom', 'vidbam', 'viidshar','allviid', 'vidspeed',
                                ...
                                'vd1bm', 'vdb2m', 'v1db2m', 'v2db3m', 'venb1m', 'v1enbm'] if x in sHostName), None)
        if val:
        ...
        if ('hexupload' in sHostName) or ('hexload' in sHostName):
        ...
        val = next((x for x in ['goved', 'govad', 'govid.me', 'goveed', 'gov1ad', 'go2ved', 'go1ved', 
                                ...
                                'gon1vd', 'goov9d','goov1d', 'gov9d', 'goov2d', 'g2v3d', 'g1ovd'] if x in sHostName), None)
        if val:
        ...
        dood = next((x for x in ['dooood.com', 'dood', 'ds2play', 'ds2video', 'd0o0d', 'do0od', 'd0000d'] if x in sHostName), None)
        if dood:
