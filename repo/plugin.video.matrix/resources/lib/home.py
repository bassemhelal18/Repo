...
class cHome:
    ...
    def load(self):
        ...
        oGui.addDir(SITE_IDENTIFIER, 'showMenuSearch', self.addons.VSlang(30076), icons + '/Search.png', oOutputParameterHandler)
    ...
    def showMenuSearch(self):
          ...
          oGui.addDir(SITE_IDENTIFIER, 'showSearchText', self.addons.VSlang(30078), icons + '/Movies.png', oOutputParameterHandler)
          
          oOutputParameterHandler.addParameter('sCat', '2')
          oGui.addDir(SITE_IDENTIFIER, 'showSearchText', self.addons.VSlang(30079), icons + '/TVShows.png', oOutputParameterHandler)
    ...
    def showMovies(self):
        ...
        oOutputParameterHandler.addParameter('sCat', '1')
        oGui.addDir(SITE_IDENTIFIER, 'showSearchText', self.addons.VSlang(30078), icons + '/Search.png', oOutputParameterHandler)
    ...
    def showSeries(self):
        ...
        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('sCat', '2')
        oGui.addDir(SITE_IDENTIFIER, 'showSearchText', self.addons.VSlang(30079), icons+'/Search.png', oOutputParameterHandler)
    ...
    def ShowTools(self):
        ...
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'showHostDirect', self.addons.VSlang(30469), icons + '/Search.png', oOutputParameterHandler)
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir('globalSources', 'globalSources', self.addons.VSlang(30138), icons + '/HosterDirect.png', oOutputParameterHandler)
        oGui.setEndOfDirectory()
